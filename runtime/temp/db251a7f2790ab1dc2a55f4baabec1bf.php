<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\xampp\htdocs\QandA\public/../application/event\view\index\contact.html";i:1503205341;}*/ ?>
<!DOCTYPE HTML>
<!--
	Alpha by HTML5 UP
	html5up.net | @n33co
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<section id="main" class="container 100%">
					...
					<div class="box">
						<form id="myform" method="post" action="./showEvent">
